                                        ...
                                        <td colspan="6">
                                            <div class="table-responsive">
                                                <table class="table table-hover table-jse" data-nivel="2">
                                                    ...
                                                    <th width="2%">#</th>
                                                    <th width="85%">{{$itemArea->Nom_Area}}</th>
                                                                            ...
                                                                            @foreach($itemArea->area as $i => $itemArea)
                                                                                <tr data-id="{{$itemArea->idAREA}}">
                                                                                    ...
                                                                                    <td>{{$itemArea->Nom_Area}}</td>
                                                                                        <td>
                                                                                            <ul class="actions">
                                                                                                <li>
                                                                                                    <a class="btn-CrearEspArea"><i class="md md-add md-lg" style="font-size: 2em;vertical-align: -50%;"></i></a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </td>
                                                                                ...
                                                                                @if(count($itemArea->area)> 0)
                                                                                    <tr class="colapcin table-colapcin panel" data-codpadre="{{$itemArea->idAREA}}">
                                                                                        ...
                                                                                        <td colspan="6">
                                                                                            <div class="table-responsive">
                                                                                                <table class="table table-hover table-jse" data-nivel="4">
                                                                                                    <thead class="bgm-orange">
                                                                                                    <th width="2%">#</th>
                                                                                                    ...
                                                                                                    @foreach($itemArea->area as $i => $itemArea)
                                                                                                        <tr data-id="{{$itemArea->idAREA}}">
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <ul class="actions">
                                                                                                                    <li>
                                                                                                                        <a class="btn-editesp"><i class="md md-edit md-lg"></i></a>
                                                                                                                    </li>
                                                                                                                    <li>
                                                                                                                        <a class="btn-delete"><i class="md md-delete md-lg"></i></a>
                                                                                                                    </li>
                                                                                                        ...
                                                                                                        @if(count($itemArea->area)> 0)
                                                                                                            <tr class="colapcin table-colapcin panel" data-codpadre="{{$itemArea->idAREA}}">
                                                                                                                ...
                                                                                                                <td colspan="6">
                                                                                                                    <div class="table-responsive">
                                                                                                                        <table class="table table-hover table-jse" data-nivel="5">
                                                                                                                            <thead class="bgm-orange">
                                                                                                                            <th width="2%">#</th>
                                                                                                                            <th width="25%">{{$itemArea->Nom_Area}}</th>
                                                                                                                            <th width="25%">Microtik</th>
                            ...
                            <div class="table-responsive">
                                <table data-id="{{$itemContrato->idCONTRATO}}" data-importe="{{$itemContrato->Importe}}" data-mbts="{{$itemContrato->Velocidad_Mb}}" data-nivel = "1" class="table table-hover table-jse">
                                                ...
                                                <td colspan="7">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-jse" data-importe="{{$itemArea1->consumo["SubTotal"]}}" data-mbts="{{$itemArea1->consumo["Mbps_Asignado"]}}" data-nivel = "2">
                                                            <thead class="bgm-cyan">
                                                            <th width="5%">#</th>
                                                            <th width="93%">{{$itemArea1->Nom_Area}}</th>
                                                            <th width="2%"></th>
                                                            </thead>
                                                            <tbody class="nivel_b">
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table table-hover table-jse"  data-importe="{{$itemArea2->consumo["SubTotal"]}}" data-mbts="{{$itemArea2->consumo["Mbps_Asignado"]}}" data-nivel = "3">
                                                                                    ...
                                                                                    @foreach($itemArea2->area as $i => $itemArea3)
                                                                                        ...
                                                                                        @if(count($itemArea3->area)> 0)
                                                                                            <tr class="colapcin table-colapcin panel" data-codpadre="{{$itemArea3->idAREA}}">
                                                                                                <td></td>
                                                                                                <td colspan="6">
                                                                                                    <div class="table-responsive">
                                                                                                        <table class="table table-hover table-jse"  data-importe="{{$itemArea2->consumo["SubTotal"]}}" data-mbts="{{$itemArea2->consumo["Mbps_Asignado"]}}" data-nivel = "3">
                                                                                                            <thead class="bgm-orange">
                                                                                                            <th width="5%">#</th>
                                                                                                            <th width="25%">{{$itemArea3->Nom_Area}}</th>
                                                                                                            <th width="10%">N° de Computadoras x nivel</th>
                                                                                                            <th width="23%" class="text-center">Mbps Asignados x nivel</th>
                                                                                                            <th width="10%">Porc. Acumulado x nivel</th>
                                                                                                            <th width="25%">Sub Total x nivel</th>
                                                                                                            <th width="2%"></th>
                                                                                                            </thead>
                                                                                                            <tbody class="nivel_d">
                                                                                                            @foreach($itemArea3->area as $i => $itemArea4)
                                                                                                                <tr class="info" data-id="{{$itemArea4->idAREA}}" data-nivel="4" data-porc="{{$itemArea4->consumo["Porc_Mbps"]}}" data-subtotal="{{$itemArea4->consumo["SubTotal"]}}">
                                                                                                                    @if(count($itemArea4->area)> 0)
                                                                                                                        <td class="card-link btn-colapcin no-seleccionable"><i class="ico-colapcin md md-keyboard-arrow-up md-lg" style="font-size: 2em;vertical-align: -50%;">{{$i+1}}</i></td>
                                                                                                                    @else
                                                                                                                        <td><i class="md md-lg" style="font-size: 2em;vertical-align: -50%;">{{$i+1}}</i></td>
                                                                                                                    @endif
                                                                                                                    <td>{{$itemArea4->Nom_Area}}</td>
                                                                                                                    <td class="num_comp" style="padding: 0;">
                                                                                                                        <div class="form-group label-floating" style="padding: 0;margin: 0;display: inline-block;width: 80%;">
                                                                                                                            <input value="{{$itemArea4->consumo["num_comp"]}}" type="number" min="0" max="1000" step="1" class="form-control" style="text-align: center; margin-bottom: 5px;">
                                                                                                                        </div>
                                                                                                                        <div style="display: inline-block;width: 10%;"> Pcs</div>
                                                                                                                    </td>
                                                                                                                        <td class="cant_mbts" style="padding: 0;">
                                                                                                                            <div class="form-group label-floating" style="padding: 0;margin: 0;display: inline-block;width: 80%;">
                                                                                                                                <input value="{{$itemArea4->consumo["Mbps_Asignado"]}}" type="number" min="0" max="1000" step="1" class="form-control input_4" style="text-align: center; margin-bottom: 5px;">
                                                                                                                            </div>
                                                                                                                            <div style="display: inline-block;width: 10%;">Mbps</div>
                                                                                                                        </td>
                                                                                                                    <td class="text-center"><div class="porc_mbts" style="display: inline-block;">{{$itemArea4->consumo["Porc_Mbps"]}}</div>&nbsp;%</td>
                                                                                                                    <td class="">S/.<div class="subtotal" style="display: inline-block;">{{$itemArea4->consumo["SubTotal"]}}</div></td>
                                                                                                                    <td class="card-link"><!--<i class="md md-add md-lg btn-ModalSubArea" style="font-size: 2em;vertical-align: -50%;"></i>--></td>

                                                                                                                </tr>
                                                                                                                @if(count($itemArea4->area)> 0)
                                                                                                                    <tr class="tr_5 colapcin table-colapcin panel" data-codpadre="{{$itemArea4->idAREA}}">
                                                                                                                        <td></td>
                                                                                                                        <td colspan="6">
                                                                                                                            <div class="table-responsive">
                                                                                                                                <table class="table table-hover table-jse"  data-importe="{{$itemArea4->consumo["SubTotal"]}}" data-mbts="{{$itemArea4->consumo["Mbps_Asignado"]}}" data-nivel = "3">
                                                                                                                                    <thead class="bgm-orange">
                                                                                                                                    <th width="5%">#</th>
                                                                                                                                    <th width="25%">{{$itemArea4->Nom_Area}}</th>
                                                                                                                                    <th width="10%">PCs</th>
                                                                                                                                    <th width="23%" class="text-center">Mbps/xPC</th>
                                                                                                                                    <th width="10%">% Asignado x PC</th>
                                                                                                                                    <th width="25%">Costo asignado x PC</th>
                                                                                                                                    <th width="2%"></th>
                                                                                                                                    </thead>
                                                                                                                                    <tbody class='nivel5_tbody'>
                                                                                                                                    @foreach($itemArea4->area as $i => $itemArea5)
                                                                                                                                        <tr data-id="{{$itemArea5->idAREA}}" data-nivel="5" data-mbps="{{$itemArea5->consumo["Mbps_Asignado"]}}" data-porc="{{$itemArea5->consumo["Porc_Mbps"]}}" data-subtotal="{{$itemArea5->consumo["SubTotal"]}}">
                                                                                                                                            @if(count($itemArea5->area)> 0)
                                                                                                                                                <td class="card-link btn-colapcin no-seleccionable"><i class="ico-colapcin md md-keyboard-arrow-up md-lg" style="font-size: 2em;vertical-align: -50%;">{{$i+1}}</i></td>
                                                                                                                                            @else
                                                                                                                                                <td><i class="md md-lg" style="font-size: 2em;vertical-align: -50%;">{{$i+1}}</i></td>
                                                                                                                                            @endif
                                                                                                                                            <td>{{$itemArea5->Nom_Area}}</td>
                                                                                                                                            <td class="num_comp" style="padding: 0;">
                                                                                                                                                <div class="form-group label-floating" style="padding: 0;margin: 0;display: inline-block;width: 80%;">
                                                                                                                                                    <input value="{{$itemArea5->consumo["num_comp"]}}" type="number" min="0" max="1000" step="1" class="form-control input_5" style="text-align: center; margin-bottom: 5px;">
                                                                                                                                                </div>
                                                                                                                                                <div style="display: inline-block;width: 10%;">Pcs</div>
                                                                                                                                            </td>
                                                                                                                                                <td class="text-center"><div class="cant_mbts" style="display: inline-block;">{{$itemArea5->consumo["Mbps_Asignado"]}}</div>&nbsp;Mbps</td>
                                                                                                                                                <td class="text-center"><div class="porc_mbts" style="display: inline-block;">{{$itemArea5->consumo["Porc_Mbps"]}}</div>&nbsp;%</td>

                                                                                                                                            <td class="">S/.<div class="subtotal" style="display: inline-block;">{{$itemArea5->consumo["SubTotal"]}}</div></td>
                                                                                                                                            <td class="card-link"><!--<i class="md md-add md-lg btn-ModalSubArea" style="font-size: 2em;vertical-align: -50%;"></i>--></td>
                                                                                                                                    ...
                                                                                                                                    <td class="text-center"><div class="totalNum_Comp" style="display: inline-block;">{{$itemArea4->totalNumComp}}</div><PCs></PCs></td>
                                                                                                                                    <td class="text-center"><div class="totalCant_Mbps" style="display: inline-block;">{{$itemArea4->totalCantMbts,1}}</div>&nbsp;Mbps</td>
                                                                                                                                    <td class="text-center"><div class="totalPorc_Mbps" style="display: inline-block;">{{$itemArea4->totalPorcMbts,2}}</div>%</td>
                                                                                                                                    <td class="text-left">S/.<div class="totalimporte_Mbps" style="display: inline-block;">{{round($itemArea5->totalImporMbts,2)}}</div></td>
                                                                                                                                    </tfoot>
                                                                                                                                </table>
                                                                                                                            </div>
                                                                                                                        </td>
                                    ...
                                    <tr >
                                        ...
                                        <td></td>
                                        <td class="td-total text-center">Total</td>
                                        <td class="text-center"><div class="totalNum_Comp" style="display: inline-block;">{{$itemContrato->totalNumComp}}</div><PCs></PCs></td>
                                        ...
                                        <td class="text-left">S/.<div class="totalimporte_Mbps" style="display: inline-block;">{{round($itemContrato->totalImporMbts,3)}}</div></td>
                                        <td colspan="2"></td>
                                    </tr>
                                    </tfoot>
                                </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 opcional">
                            <div class="form-group label-floating">
                                <label class="control-label">Dependencia ADM</label>
                                <input id="text_DEP" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6 opcional">
                            <div class="form-group label-floating">
                                <label class="control-label">OBS</label>
                                <input id="text_OBS" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6 opcional">
                            <div class="form-group label-floating">
                                <label class="control-label">Nivel CTR</label>
                                <input id="text_CTR" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6 opcional">
                            <div class="form-group label-floating">
                                <label class="control-label">Nivel CTW</label>
                                <input id="text_CTW" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#btn-addArea").on('click',function(){
                ...
                var mstr_dep = $('#text_DEP').val();
                var mstr_obs = $('#text_OBS').val();
                var mstr_ctr = $('#text_CTR').val();
                var mstr_ctw = $('#text_CTW').val();
                var mint_DispositivoArea = $('#sel_DispositivoArea').val();
                var mint_CodPadre =  $('#mdlCrearAreas').data('idCodPadre');
                var data = {nombre: mstr_nombreArea, interface: mstr_interface, ctr: mstr_ctr,dependencia:mstr_dep,obs:mstr_obs,ctw:mstr_ctw, idDispositivo: mint_DispositivoArea, idAreaEdit: mint_idAreaEdit, idCodPadre: mint_CodPadre};
                console.log(data);
                $.ajax({
                    type: "POST",
                    url: '{{url("/pagPuntosAccesos/CrearArea")}}',
                    data: {nombre: mstr_nombreArea, interface: mstr_interface, ctr: mstr_ctr,dependencia:mstr_dep,obs:mstr_obs,ctw:mstr_ctw, idDispositivo: mint_DispositivoArea, idAreaEdit: mint_idAreaEdit, idCodPadre: mint_CodPadre},
                    dataType: 'json',
                    ...
                    success: function (data) {
                        ...
                        //location.reload();
                        console.log(data.Cod_Padre+"ella");
            ...
            function agregarSubArea(data,mint_idAreaEdit){
                ...
                if(mobj_tr.data('codpadre') != undefined || mobj_tr.data('codpadre') != null){
                    ...
                    if(mint_nivel == 1 || mint_nivel==2 )
                    {
                        html +='<ul cla ss="actions"><li><a class="btn-CrearArea"><i class="md md-add md-lg" style="font-size: 2em;vertical-align: -50%;"></i></a> </li> </ul> '
                        html +=  '</td>'+
                                '<td>'+
                    ...
                    if(mint_nivel==4 || mint_nivel == 3)
                    {
                        html +='<ul class="actions"><li><a class="btn-CrearEspArea"><i class="md md-add md-lg" style="font-size: 2em;vertical-align: -50%;"></i></a> </li> </ul> '
                        html +=  '</td>'+
                                '<td>'+
                                '<ul class="actions"> <li> <a class="btn-editesp"><i class="md md-edit md-lg"></i></a> </li> <li> <a class="btn-delete"><i class="md md-delete md-lg"></i></a> </li> </ul>'+
                                '</td>'+
                                '</tr>';
                    }
                    if(mint_nivel == 5)
                    ...
                    console.log(data.Cod_Padre+"data cod padre");
                    console.log(mint_Nivel+"nivel");
                    ...
                    {
                        console.log("mir");
                html += '<tr class="colapcin panel table-colapcin" data-codpadre="'+mint_idArea+'">'+
                        '<td></td>'+
                        '<td colspan="6">'+
                        '<div class="table-responsive">'+
                    ...
                    if(mint_Nivel == 1 || mint_Nivel == 2 || mint_Nivel == 3 )
                    {
                        html +=  '<ul class="actions"> <li> <a class="btn-edit"><i class="md md-edit md-lg"></i></a> </li> <li> <a class="btn-delete"><i class="md md-delete md-lg"></i></a> </li> </ul>'

                    }
                    if(mint_Nivel == 4 || mint_Nivel == 5 )
                    {
                        html +=  '<ul class="actions"> <li> <a class="btn-editesp"><i class="md md-edit md-lg"></i></a> </li> <li> <a class="btn-delete"><i class="md md-delete md-lg"></i></a> </li> </ul>'
...
console.log(mobj_tr.html());
            ...
            $('#cardSinAsignar').on('click','.btn-CrearArea',function(){
                ...
                $('#text_CTR').val('');
                $('#text_DEP').parents('.form-group').eq(0).addClass('is-empty');
                $('#text_DEP').val('');
                $('#text_OBS').parents('.form-group').eq(0).addClass('is-empty');
                $('#text_OBS').val('');
                $('#text_CTW').parents('.form-group').eq(0).addClass('is-empty');
                $('#text_CTW').val('');
            });
            $('#cardSinAsignar').on('click','.btn-CrearEspArea',function(){
                //if($(this).hasClass('btn-Principal')){}
                var mint_codpadre = $(this).parents('tr').eq(0).data('id');
                if(mint_codpadre == undefined && mint_codpadre == null)
                {
            ...
            $('.btn-validar').on('click',function(){
                ...
                mobj_card.find('input[type="number"]').each(function(){
                    ...
                    var mint_Nivel= $(this).parents('tr').data('nivel');
                    ...
                    if(mint_Nivel==4){
                        if(t==0){
                            ...
                            cant_mbps=$(this).val();
                            t=0;
                            var html_4=$(this).parent().parent().parent();
                           /*
                            porc_mbps=$(this).parent().parent().parent().children().find('.porc_mbts').text();
                            sub_total=$(this).parent().parent().parent().children().find('.subtotal').text();
                        */
                            porc_mbps=$(html_4).data('porc');
                            sub_total=$(html_4).data('subtotal');
                        }
                    ...
                    if(mint_Nivel==5){
                        num_comp=0;
                        num_comp=$(this).val();
                        var html_5=$(this).parent().parent().parent();
                        //console.log(html_5.html());
                        /*
                        cant_mbps=$(this).parent().parent().parent().children().find('.cant_mbts').text();
                        porc_mbps=$(this).parent().parent().parent().children().find('.porc_mbts').text();
                        sub_total=$(this).parent().parent().parent().children().find('.subtotal').text();
                        */
                        cant_mbps=$(html_5).data('mbps');
                        porc_mbps=$(html_5).data('porc');
                        sub_total=$(html_5).data('subtotal');
                    }
                    if(t==0){
...
/*
            ...
            */
            ...
            $('.input_5').on('keyup',function(){
                listar(this);
            });
            $('.input_5').on('click',function(){
                listar(this);
            });
            function listar2(m_conten){
//                $(m_conten).parents('.card-contrato').find('table').each(function(){
                var parent_general= $(m_conten).parents('.card-contrato').find('table');
                //--
                console.log("que pena");
                var mint_globalNivel = $(parent_general).data('nivel');
                var mint_globalImporte = $(parent_general).data('importe');
                var mint_globalCantMbps = $(parent_general).data('mbts');

                var totalporc_Mbps = 0;
                var totalcant_Mbps = 0;
                var totalimporte_Mbps = 0;

                console.log(mint_globalNivel+"global nivel");
                console.log(mint_globalImporte+"importe");
                console.log(mint_globalCantMbps+"mbts");
                //-----

                var padre1=$(m_conten).parent();

                var padre2=$(padre1).parent();
                var padre3=$(padre2).parent();
                var padre4=$(padre3).parent();
                var padre2_tbody=$(m_conten).parents('.nivel5_tbody');
                var tr_padre_5=$(m_conten).parents('tr.tr_5');
                var tr_act_4=$(m_conten).parents('tr');
                var nivel1=$(m_conten).parents('.nivel_a');
                //console.log($(tr_act_4).html());

                    var cant_mbps =$(tr_act_4).children('.cant_mbts').find('input').eq(0).val();
                    var porc_mbps=parseFloat(cant_mbps/mint_globalCantMbps);
                var sub_total=parseFloat(porc_mbps*mint_globalImporte);
                $(tr_act_4).data('porc',porc_mbps);
                $(tr_act_4).data('subtotal',sub_total);
                console.log($(tr_act_4).find('.porc_mbts').html());
                $(padre3).find('.porc_mbts').text((porc_mbps*100).toFixed(2));
                $(padre3).find('.subtotal').text(sub_total.toFixed(2));

console.log("data porc"+ $(tr_act_4).data('porc'));
                console.log("data subtotal"+ $(tr_act_4).data('subtotal'));
                var total_porc_mbts=0;
                var total_sub_total=0;
                //console.log($(nivel1).html());
                $(nivel1).find('tr.colapcin').each(function(){
                 console.log($(this).html());
                });
                console.log(total_porc_mbts+"total_porc_mbts");
...
//                $(m_conten).parents('.card-contrato').find('table').each(function(){
                ...
                var padre4=$(padre3).parent();
                var padre2_tbody=$(m_conten).parents('.nivel5_tbody');
                var table=$(padre2_tbody).parent();
                var tfoot=$(table).children('tfoot');
                var tr_padre_5=$(m_conten).parents('tr.tr_5');
                //console.log($(padre2_tbody).html());
                var x=0;
                var total_numcomp=0;

                $(padre2_tbody).find('tr').each(function(){
                    x++;
                   var num_comp =parseFloat($(this).children('.num_comp').find('input').eq(0).val());
console.log(x+"hi :v");
                    total_numcomp=total_numcomp+num_comp;
                    //console.log($(this).html());
                });
                var idpadre=$(tr_padre_5).data('codpadre');
                var parent_idpadre=$(tr_padre_5).parent();
                var cant_mbts=0;
                var porc_mbts=0;
                $(parent_idpadre).find('tr').each(function(){
                    var id=$(this).data('id');
                    if(idpadre==id){
                        console.log("cars3");
                       // console.log($(this).html());
                        console.log("porc e"+$(this).data('porc'));
                        console.log("sub total e"+$(this).data('subtotal'));
                        cant_mbts =parseFloat($(this).children('.cant_mbts').find('input').eq(0).val());
                        //porc_mbts =parseFloat($(this).find('.porc_mbts').text());
                        porc_mbts =parseFloat($(this).data('porc'));
                        $(this).children('.num_comp').find('input').eq(0).val(total_numcomp);
                    }
                });
                var total_mbts_asig=0;
                console.log(cant_mbts+"cantidad mbts");
                console.log(porc_mbts+"porc mbts");

                $(padre2_tbody).find('tr').each(function(){
                    var num_comp =parseFloat($(this).children('.num_comp').find('input').eq(0).val());
                    console.log(num_comp+"num comp");
                    console.log("("+cant_mbts+"/"+total_numcomp+")*"+num_comp);
                    var mbts_asig=parseFloat((cant_mbts/total_numcomp)*num_comp);
                    $(this).data('mbps',mbts_asig);
                    $(this).find('.cant_mbts').text(mbts_asig.toFixed(3));
                    total_mbts_asig=total_mbts_asig+mbts_asig;
                });
                console.log(total_mbts_asig+"total mbts asig");
                var total_porc_mbts=0;
                $(padre2_tbody).find('tr').each(function(){
                    //var cant_mbtshijo=$(this).find('.cant_mbts').text();
                    var cant_mbtshijo= $(this).data('mbps');
                    var porc_mbtshijo=parseFloat((porc_mbts/total_mbts_asig)*cant_mbtshijo);
                    $(this).data('porc',porc_mbtshijo);
                    $(this).find('.porc_mbts').text((porc_mbtshijo*100).toFixed(2));
                    total_porc_mbts=total_porc_mbts+porc_mbtshijo;
                });
                var total_subtotal=0;
                $(padre2_tbody).find('tr').each(function(){
                    //var porc_mbtshijo2=$(this).find('.porc_mbts').text();
                    var porc_mbtshijo2= $(this).data('porc');
                    var sub_totalhijo=parseFloat((porc_mbtshijo2*mint_globalImporte));
                    console.log("sub_totalhijo"+sub_totalhijo);
                    $(this).data('subtotal',sub_totalhijo);
                    $(this).find('.subtotal').text(sub_totalhijo.toFixed(2));
                    total_subtotal=total_subtotal+sub_totalhijo;
                });
                $(tfoot).find('.totalNum_Comp').text(total_numcomp);
                $(tfoot).find('.totalCant_Mbps').text(total_mbts_asig.toFixed(1));
                $(tfoot).find('.totalPorc_Mbps').text((total_porc_mbts*100).toFixed(2));
                $(tfoot).find('.totalimporte_Mbps').text(total_subtotal.toFixed(2));
            ...
            $('#cardSinAsignar').on('click','.btn-edit',function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#text_DEP').parents('.form-group').eq(0).removeClass('is-empty');
                        $('#text_DEP').val(data.Dependencia);
                        $('#text_OBS').parents('.form-group').eq(0).removeClass('is-empty');
                        $('#text_OBS').val(data.Obs);
                        $('#text_CTW').parents('.form-group').eq(0).removeClass('is-empty');
                        $('#text_CTW').val(data.CTW);
            ...
            $('#cardSinAsignar').on('click','.btn-editesp',function(){
                $('#mdlCrearAreas').find('.modal-title').html('Editar Area');
                var mint_idArea = $(this).parents('tr').eq(0).data('id');
                $.ajax({
                    type: "POST",
            ...
            //neoangel
            $('#lst_Contratos').on('click','.btn-excelreporte',function(){
                var mint_idcontrato = $(this).data('idcontrato');
                $('#mdlReporte').data('idcontrato',mint_idcontrato);
                var mstr_fechaHasta =  $('#text_fechaHasta').val();
                var mstr_fechaDesde = $('#text_fechaDesde').val();
                var mint_idcontrato =$('#mdlReporte').data('idcontrato');
                $('#ifr_reporte').html('');
                var html = '<iframe src="'+'{{url("/pagPuntosAccesos")}}/'+mint_idcontrato+'/'+mstr_fechaDesde.split('/').join('-')+'/'+mstr_fechaHasta.split('/').join('-')+'" height="600px" width="100%" frameborder="0" style="border: 0" allowfullscreen></iframe>';
                var tempDiv = document.createElement('div');
                tempDiv.innerHTML = html;
                $('#ifr_reporte').append(tempDiv);
